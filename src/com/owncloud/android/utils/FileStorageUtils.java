...
public class FileStorageUtils {
    ...
    public static final String getSavePath(String accountName) {
        ...
        return sdCard.getAbsolutePath() + "/vegadrive/" + Uri.encode(accountName, "@");
    ...
    public static final String getTemporalPath(String accountName) {
        File sdCard = Environment.getExternalStorageDirectory();
        return sdCard.getAbsolutePath() + "/vegadrive/tmp/" + Uri.encode(accountName, "@");
            // URL encoding is an 'easy fix' to overcome that NTFS and FAT32 don't allow ":" in file names, that can be in the accountName since 0.1.190B
    }
    ...
    public static final String getLogPath()  {
        return Environment.getExternalStorageDirectory() + File.separator + "vegadrive" + File.separator + "log";
    }
